...
static const char *colorname[] = {
	...
	"#dc322f", // Ansi 1 Color (normal red)
	"#859901", // Ansi 2 Color (bright green)
	"#b58901", // Ansi 3 Color (bright yellow)
	"#268bd2", // Ansi 4 Color (normal blue)
	"#d33682", // Ansi 5 Color (bright magenta)
	"#2aa198", // Ansi 6 Color (normal cyan)
	"#eee8d5", // Ansi 7 Color (normal white)
	"#002833", // Ansi 8 Color (bright black)
	"#cb4b16", // Ansi 9 Color (bright red)
	"#859901", // Ansi 10 Color (normal green)
	"#b58901", // Ansi 11 Color (normal yellow)
	"#268bc2", // Ansi 12 Color (bright blue)
	"#d33682", // Ansi 13 Color (normal magenta)
	"#93a1a1", // Ansi 14 Color (bright cyan)
	"#fdf6e3", // Ansi 15 Color (bright white)
	[255] = 0,
